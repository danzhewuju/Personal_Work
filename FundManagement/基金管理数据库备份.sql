...
REPLACE INTO `invest` (`iid`, `uid`, `fid`, `mode`, `firstdate`, `today`, `getincome`, `thisincome`, `count`, `amount`, `proalo`, `rifa`, `invest`, `firstyearprofit`, `bsale`) VALUES
	...
	(3, 10000, 100001, '周投', '2017-07-29', '2017-07-30', 12, 25, 1, 35, 45, 212, 5000, 0.36, 1),
	...
	(9, 10000, 100001, '周投', '2017-07-29', '2017-07-31', 2500, 475, 2, 300000, 3000, -0.0012, 1000, 0.5788, 1),
